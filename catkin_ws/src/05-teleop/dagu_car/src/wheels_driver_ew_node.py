...
class WheelsDriverNode(object):
    def __init__(self):
        ...
        self.msg_encoder = Vector3()
        self.pub_wheels_cmd = rospy.Publisher("~wheels_cmd_executed",WheelsCmdStamped, queue_size=1)
        self.pub_encoder_msg = rospy.Publisher("~encoder",Vector3, queue_size=1)
...
<<<<<<< HEAD
            self.msg_encoder.x = 0
            self.msg_encoder.y = 0
            self.pub_encoder_msg.publish(self.msg_encoder)
=======
            self.pub_encoder_msg.publish() # publish zero
>>>>>>> refs/remotes/origin/master
        ...
        # EWING
        self.msg_encoder.x = msg.vel_left
        self.msg_encoder.y = msg.vel_right
        self.pub_encoder_msg.publish(self.msg_encoder)
